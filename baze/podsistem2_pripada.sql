...
CREATE TABLE `pripada` (
  ...
  `idKat` int NOT NULL,
  PRIMARY KEY (`idPri`),
  KEY `FK_pripada_idArt_idx` (`idArt`),
  KEY `FK_pripada_idKat_idx` (`idKat`),
  CONSTRAINT `FK_pripada_idArt` FOREIGN KEY (`idArt`) REFERENCES `artikal` (`idArt`) ON UPDATE CASCADE,
...
INSERT INTO `pripada` VALUES (25,39,20),(26,40,21),(27,41,19),(28,42,19),(29,43,19),(30,44,19);
